...
async fn http_group_cap_is_policy_controlled()
{
    ...
    policy
        ...
        .category_caps
        .insert(
            cfprobe::EvidenceCategory::
                Http,
            cfprobe::ScoreCap::new(
                0,
                0,
            ),
        );
